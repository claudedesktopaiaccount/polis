...
export const metadata: Metadata = {
  title: "Newsletter",
  description: "VolímTo Týždenník — týždenný prehľad slovenských politických prieskumov a predikcií. Zadarmo, každý piatok.",
};

export default function NewsletterPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-16">
      <h1 className="font-serif text-3xl font-bold text-ink mb-4">VolímTo Týždenník</h1>
