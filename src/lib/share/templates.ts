...
export function generateQuizCard({ topParty, topScore, partyColor }: QuizCardProps): string {
  ...
  <text x="60" y="100" font-family="Georgia, serif" font-size="24" fill="#111110" opacity="0.4">POLIS · VOLEBNÝ KALKULÁTOR</text>
  ...
  <text x="60" y="560" font-family="system-ui" font-size="20" fill="#111110" opacity="0.4">polis.sk/volebny-kalkulator</text>
</svg>`;
}
...
export function generateScoreCard({ score, rank, totalUsers }: ScoreCardProps): string {
  ...
  <text x="60" y="100" font-family="Georgia, serif" font-size="24" fill="#111110" opacity="0.4">POLIS · PREDIKCIA VOLIEB</text>
  ...
  <text x="60" y="560" font-family="system-ui" font-size="20" fill="#111110" opacity="0.4">polis.sk/tipovanie</text>
</svg>`;
}
